...
<small>*The model currently does not recognize the AGE class in the i2b2 data set properly. This might be due to the small amount of samples in the training set (14 token) and the test set (3 samples). We did not do any in-depth evaluations, to fix this issue until now.*</small>
